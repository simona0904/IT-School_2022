...
# find:  ret daca un sub-str face parte dintr-un str dar ne returneaza indexul 
...
# pprint(clean_words)    # pprint printeaza una sub alta in consola

# .strip(): da la o parte ce este in jurul str (la capete, stanga-dreapta)  
# intre paranteze trebuie sa ii dam lista de caractere care vor fi eliminate.  
